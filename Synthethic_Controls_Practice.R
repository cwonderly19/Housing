...
Synth_Practice$P_08 <- ifelse(Synth_Practice$P_08 > 0, 0,0)
Synth_Practice$P_09 <- ifelse(Synth_Practice$P_09 > 0, 0,0)
Synth_Practice$P_10 <- ifelse(Synth_Practice$P_10 > 0, 0,0)
Synth_Practice$P_07 <- ifelse(Synth_Practice$P_11 > 0, 0,0)
Synth_Practice$P_08 <- ifelse(Synth_Practice$P_12 > 0, 0,0)
Synth_Practice$P_07 <- ifelse(Synth_Practice$P_13 > 0, 0,0)
Synth_Practice$P_08 <- ifelse(Synth_Practice$P_14 > 0, 0,0)
Synth_Practice$P_07 <- ifelse(Synth_Practice$P_15 > 0, 0,0)
